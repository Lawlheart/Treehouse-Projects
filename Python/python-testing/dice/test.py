...
class DieTests(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertIsInstance(repr(self.d6), str)
        self.assertIn(int(repr(self.d6)), range(1, 6))
...
class RollTests(unittest.TestCase):
    ...
    def test_repr(self):
        self.assertIsInstance(repr(self.hand3), str)
        self.assertIn(int(repr(self.hand3)), range(3, 18))
